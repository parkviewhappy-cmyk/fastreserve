 ...
 * 첫 번째 Site Adapter 구현체. Session/Reservation URL/Site 연결을 담당하며,
 * 실제 Browser 제어/로그인/결제를 전혀 수행하지 않는 Mock 구현이다.
 * Interpark Plugin이 이 Adapter를 감싸서 사용한다(Plugin -> Adapter).
 *
 * 기능 범위(PM 지시, Sprint 6/7): Session 확인 / Reservation URL 확인 / ExecutionResult 반환.
 * Version/Capability는 Plugin의 책임이므로 Adapter는 다루지 않는다.
 */
